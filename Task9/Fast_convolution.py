...
def FastConvolution(indices_signal1,samples_signal1,indices_signal2,samples_signal2):
...
signal1='Task9/Files/Input_conv_Sig1.txt'
signal2='Task9/Files/Input_conv_Sig2.txt'
indices_signal1,samples_signal1=load_file(signal1)
indices_signal2,samples_signal2=load_file(signal2)
convolution_indices,convolution_samples=FastConvolution(indices_signal1,samples_signal1,indices_signal2,samples_signal2)
ConvTest(convolution_indices,convolution_samples)
plot_signals_convolution(indices_signal1,samples_signal1,indices_signal2,samples_signal2,convolution_indices,convolution_samples)