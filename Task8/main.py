...
from Task8.Correlation import calculate_correlation
...
class Task8:
    ...
    def create_widgets(self):
        ...
        self.correlation_button_image = PhotoImage(file="../DSP_Tasks/Photos/Task8/corr.png")
        self.correlation_button = Button(self.root, image=self.correlation_button_image, borderwidth=0,
                                         cursor="hand2", bd=0, background='#141345', activebackground='#141345',
                                         command=lambda: calculate_correlation(self.choose_file1.get(), self.choose_file2.get()))
    ...
    def placing_widgets(self):
        ...
        self.correlation_button.place(anchor='center', relx=0.5, y=370)
