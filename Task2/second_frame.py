...
def subtraction(signal1_file_path, signal2_file_path):
...
class Subtraction:
    def __init__(self, root):
        ...
        # create widgets
        choose_signals = Image.open("../DSP_Tasks//Photos/Task2/choose_signals_subtract.png")
        ...
        get_result_button = Button(root, image=self.get_result_button_image, borderwidth=0, cursor="hand2", bd=0,
                                   ...
                                   command=lambda: subtraction(self.signal1_selected_file, self.signal2_selected_file))
